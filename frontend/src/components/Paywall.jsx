...
// Pro upgrade screen shown to authenticated free-tier users. Owns the
// "redirecting to Stripe" loading state internally — the App doesn't
// need to know about it because the flow ends in window.location.href
// (the React tree gets torn down).
export default function Paywall({ onTokenRefresh }) {
